    ...
    <div className={styles.contact_wrapper}>
        <div className={styles.contact_con}>
            <div className={styles.contact_info}>
                ...
                <p><MdAlternateEmail/>65020799@up.ac.th</p>
                <p><SiWhatsapp/>093 xxx xxxx</p>
            </div>
                ...
                <form action="">
                    <div className={styles.input_group}>
                        <div>
                            ...
                            <input type="text" placeholder="eg. Jindaporn"></input>
                        </div>
                        <div>
                            <label htmlFor="last name">Last Name</label>
                            <input type="text" placeholder="eg. Intajak"></input>
                        </div>
                    </div>
                    <label htmlFor="email address">Email Address</label>
                    <input type="email" placeholder="eg. asdfsa@gmail.com" />
